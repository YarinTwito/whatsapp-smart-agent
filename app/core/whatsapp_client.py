...
class WhatsAppClient:
    ...
    def is_valid_message(body: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if not (
                body.get("object") == "whatsapp_business_account" and body.get("entry")
            ):
                return False
    ...
    async def send_message(self, to: str, message: str) -> dict:
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 401:
                    ...
                    if "Session has expired" in response_body:
                        print(
                            "ERROR: WhatsApp token has expired. Please update your token."
                        )
            ...
            if isinstance(e, httpx.TimeoutException):
                raise HTTPException(
                    status_code=408, detail=f"Request timed out: {str(e)}"
                )
    ...
    async def send_document(
        self, to: str, document_url: str, caption: str = ""
    ) -> Dict[str, Any]:
