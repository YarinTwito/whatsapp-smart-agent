...
def test_processed_message_creation():
    msg = MockProcessedMessage(message_id="test_123", timestamp="1234567890")
...
def test_real_processed_message():
    ...
    msg = ProcessedMessage(message_id="real_test_123", timestamp="1234567890")
