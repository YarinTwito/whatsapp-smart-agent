...
def test_twilio_client_init():
    client = TwilioWhatsAppClient(sid="test_sid", token="test_token", from_number="1234567890")
    ...
    client2 = TwilioWhatsAppClient(sid="test_sid", token="test_token", from_number="whatsapp:+1234567890")
